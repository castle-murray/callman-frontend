          ...
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              {isAuthenticated && user?.user?.isOwner && (
                <a href="/dash/settings" className="text-primary hover:underline dark:text-dark-text-blue dark:hover:text-dark-primary-hover">
        ...
        <div className="md:hidden fixed inset-0 z-50 bg-black/50" onClick={() => setIsMobileMenuOpen(false)}>
          ...
          >
            <div className="flex flex-col py-4">
              ...
              {isAuthenticated && user?.user?.isOwner && (
                <a href="/dash/settings" className="flex items-center space-x-2 text-primary hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-dark-text-blue dark:hover:text-dark-primary-hover px-4 py-3">
