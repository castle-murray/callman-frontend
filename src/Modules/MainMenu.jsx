        ...
        <div className="mb-6">
            <div className="relative">
                <button
                    ...
                    className="bg-primary text-dark-text-primary p-2 rounded hover:bg-primary-hover dark:bg-dark-primary dark:hover:bg-dark-primary-hover flex items-center"
                >
                    Menu
